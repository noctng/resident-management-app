...
async function main() {
    console.log('Updating UTILITY_BILL template to Professional version...');
...
<head>
    ...
    <title>Thông Báo Tiền Điện Nước</title>
</head>
...
<div style="max-width: 650px; margin: 20px auto; padding: 4px; border: 1px solid #e0e6ed; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.05);">
    ...
    <p style="margin: 2px 0 6px; font-size: 14px; line-height: 1.15;">Ban Quản lý xin thông báo chi phí tiền điện nước của căn hộ <strong>{{apartment_code}}</strong> trong kỳ <strong>{{month_year}}</strong> như sau:</p>
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 6px 0; font-size: 13px; border: 1px solid #d9e2ec;">
        ...
        <tr style="background-color: #fff9f9;">
            <td style="padding: 3px 4px; border: 1px solid #d9e2ec; font-weight: bold; line-height: 1.15;">Tổng cộng (A)+(B)</td>
            <td style="padding: 3px 4px; border: 1px solid #d9e2ec; color: #d32f2f; font-weight: bold; line-height: 1.15;">{{total_cost}}</td>
        </tr>
        <tr>
