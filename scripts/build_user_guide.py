...
add_image(f'{SHOTS}/30-dashboard-kpi.png', 6.0, 'Hình 3.5b — Báo cáo KPI Tổng quan (chuẩn MONOLITH): 4 thẻ chỉ số có accent riêng, thẻ Tỷ lệ lấp đầy nổi bật')
...
add_image(f'{SHOTS}/31-apartments-cards.png', 5.8, 'Hình 3.7b — Chế độ xem thẻ căn hộ (Card Inventory, chuẩn MONOLITH Units): grid thẻ + badge trạng thái Đã/Chưa bàn giao')
...
add_image(f'{SHOTS}/32-feedback-empty.png', 5.6, 'Hình 3.9b — Trạng thái rỗng (Empty State) khi không có phản ánh / không khớp bộ lọc')
add_image(f'{SHOTS}/21-admin-Tinch.png', 5.6, 'Hình 3.10 — Quản lý Tiện ích & đặt chỗ')
add_image(f'{SHOTS}/33-amenity-empty.png', 5.6, 'Hình 3.10b — Trạng thái rỗng (Empty State) danh sách đặt chỗ / lịch sử tiện ích')
